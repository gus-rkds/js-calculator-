  ...
  return (
    <div className="container">
      <div className="grid">
        ...
        <div onClick={allClear} className="padButton AC color-red">AC</div>
        <div onClick={clear} className="padButton C color-red">C</div>
        ...
        <div onClick={calculate} className="padButton equal color-blue">=</div>
